...
export default function ServiceAreaMap() {
  return (
    <section className="bg-paint-cream py-24 md:py-32 border-t border-paint-ink/10" aria-labelledby="area-heading">
      <div className="max-w-[1400px] mx-auto px-6 md:px-10 lg:px-14">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end mb-12">
          <div className="lg:col-span-8">
            ...
            <ScrollReveal delay={0.1}>
              <h2 id="area-heading" className="mt-4 display-heavy uppercase text-paint-ink text-[48px] sm:text-[72px] md:text-[92px] lg:text-[112px] leading-[0.9]">
        ...
        <ScrollReveal delay={0.3}>
          <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 border-t border-paint-ink/15">
            {company.cities.map((city, i) => (
              ...
              >
                ...
                <p className="mt-2 display-cond text-2xl md:text-3xl text-paint-ink">{city}</p>
              </li>
            ))}
          </ul>
        </ScrollReveal>
