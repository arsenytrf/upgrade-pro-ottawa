      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-10 lg:px-14">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end mb-12">
          <div className="lg:col-span-8">
            <ScrollReveal><span className="stencil text-paint-clay">05 — Where We Work</span></ScrollReveal>
          ...
          <div className="lg:col-span-4 lg:pb-4">
            <ScrollReveal delay={0.2}>
              <p className="text-paint-cream/75 leading-relaxed">Based in Ottawa, serving the NCR. Don&rsquo;t see your area? Give us a ring.</p>
            </ScrollReveal>
          </div>
        </div>
        ...
        <ScrollReveal delay={0.3}>
          <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 border-t border-paint-cream/15">
            {company.cities.map((city, i) => (
              <li key={city} className={["border-b border-paint-cream/15 py-6 px-4", (i % 5 !== 0) ? "sm:border-l sm:border-l-paint-cream/15" : ""].join(" ")}>
