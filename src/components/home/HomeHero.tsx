...
export default function HomeHero() {
  ...
  return (
    <section ref={heroRef} className="relative bg-paint-ink text-paint-cream overflow-hidden">
      <div data-hero-bg className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url(${heroImages.main})` }} aria-hidden="true" />
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-10 lg:px-14 pt-24 md:pt-32 lg:pt-40 pb-24 md:pb-32">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-end">
          <div className="lg:col-span-8">
            <div data-hero-stamp className="inline-flex items-center gap-3 mb-10 border border-paint-cream/25 px-3 py-2">
              ...
              <span className="stencil text-paint-cream/85">Painters · Ottawa + Gatineau</span>
            </div>
          ...
          <div className="lg:col-span-4">
            <div data-hero-card className="relative aspect-[3/4] overflow-hidden shadow-2xl shadow-black/50 photo-hover">
              ...
              <div className="absolute left-5 right-5 bottom-5 text-paint-cream">
                ...
                <p className="display-cond text-2xl md:text-3xl leading-tight">
                  Clean lines.<br /><span className="text-paint-clay">Proper prep.</span>
                </p>
              </div>
            </div>
        ...
        <div data-hero-trust className="mt-16 md:mt-24 border-t border-paint-cream/15 pt-8 flex flex-wrap items-center gap-x-10 gap-y-4">
          {["Fully Insured","Free Written Estimates","Ottawa + Gatineau"].map((t) => (
            <span key={t} className="flex items-center gap-2.5 stencil text-paint-cream/75">
              <span className="w-1.5 h-1.5 bg-paint-clay" /> {t}
            </span>
          ))}
        </div>
      </div>
