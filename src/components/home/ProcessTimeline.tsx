...
export default function ProcessTimeline() {
  return (
    <section className="relative bg-paint-bone py-24 md:py-32 border-t border-paint-ink/10">
          ...
          <div className="lg:col-span-8">
            ...
            <ScrollReveal delay={0.1}>
              <h2 className="mt-4 display-heavy uppercase text-paint-ink text-[48px] sm:text-[72px] md:text-[92px] lg:text-[112px] leading-[0.9]">
                Same four steps.<br />
                <span className="text-paint-clay">Every job.</span>
              </h2>
            </ScrollReveal>
          </div>
          <div className="lg:col-span-4 lg:pb-4">
            <ScrollReveal delay={0.2}>
              <p className="text-paint-ink/75 leading-relaxed">
                Repeatable, explainable, documented in writing before we start —
                on a single feature wall or a full exterior.
              </p>
            </ScrollReveal>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
          {STEPS.map((s, i) => (
            <ScrollReveal key={s.n} delay={i * 0.08}>
              <article className="relative overflow-hidden bg-paint-cream photo-hover group border border-paint-ink/10">
                <div className="relative aspect-[4/5]">
                  <img src={sectionImages.process[i]} alt="" className="absolute inset-0 w-full h-full object-cover opacity-90 group-hover:opacity-100 transition-opacity duration-500" />
                  ...
                  <div className="absolute left-5 right-5 bottom-5 text-paint-cream">
                    ...
                    <p className="mt-3 text-sm leading-relaxed text-paint-cream/80">
                      {s.body}
                    </p>
                  </div>
                </div>
