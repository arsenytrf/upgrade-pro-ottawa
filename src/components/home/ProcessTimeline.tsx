        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
          {STEPS.map((s, i) => (
            <ScrollReveal key={s.n} delay={i * 0.08}>
              <article className="relative overflow-hidden bg-paint-charcoal photo-hover group">
                <div className="relative aspect-[4/5]">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-paint-ink via-paint-ink/60 to-paint-ink/20" />
                  ...
                  <div className="absolute left-5 right-5 bottom-5 text-paint-cream">
                    ...
                    <p className="mt-3 text-sm leading-relaxed text-paint-cream/75">
                      {s.body}
                    </p>
                  </div>
                </div>
