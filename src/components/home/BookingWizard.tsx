...
const INPUT =
  "w-full bg-paint-ink/60 border border-paint-cream/20 px-4 py-3.5 text-sm text-paint-cream placeholder:text-paint-cream/35 focus:border-paint-clay focus:outline-none transition-colors";
...
export default function BookingWizard() {
  ...
  if (status === "success") {
    return (
      <div className="relative bg-paint-charcoal text-paint-cream border border-paint-cream/15 shadow-2xl shadow-black/40">
                ...
                <div
                  className={`w-8 h-8 flex items-center justify-center text-xs font-bold transition-all ${
                    current
                      ...
                      : completed
                      ? "bg-paint-cream text-paint-cream"
                      : "border border-paint-cream/20 text-paint-cream/40"
                  }`}
                >
              ...
              {SERVICES.map((svc) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className={`mt-1 text-xs leading-snug ${selected ? "text-paint-cream/80" : "text-paint-cream/50"}`}>
                      {svc.desc}
                    </p>
                    {selected && (
              ...
              {SCOPES.map((scope) => (
                <button
                  ...
                  className={`px-4 py-2.5 stencil border transition-all ${
                    data.scope === scope.id
                      ? "border-paint-clay bg-paint-clay text-paint-cream"
                      : "border-paint-cream/20 text-paint-cream/70 hover:border-paint-cream/60 hover:text-paint-cream"
                  }`}
                >
                  {scope.label}
                </button>
              ...
              {TIMELINES.map((tl) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className={`text-xs md:text-sm pl-8 ${selected ? "text-paint-cream/80" : "text-paint-cream/55"}`}>
                      {tl.desc}
                    </p>
                    {selected && (
          ...
          <div>
            ...
            <div className="mt-6 border border-paint-cream/15 divide-y divide-paint-cream/10 bg-paint-ink/40">
              ...
              {data.details && (
                <div className="p-4 md:p-5">
                  ...
                  <p className="text-sm text-paint-cream/75">{data.details}</p>
                </div>
              )}
            </div>
            ...
            <div className="mt-5 p-4 md:p-5 bg-paint-clay/15 border border-paint-clay/40 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-paint-cream/60 mt-1">
